...
namespace ConsoleApplication3
{
    ...
    class Program
    {
        private static string subdivision = "subdivision";
        private static string quantity = "quantity";
        private static string filePath = "D:\\workspace\\c_sharp\\files\\lb5\\file.txt";
        private static string[] subdevisions = { "Accounting", "HRD", "PD", "R&D" };
