...
namespace ConsoleApplicationStudents
{
    ...
    class Program
    {
        private static string subdivision = "subjects";
        private static string quantity = "absences";
        private static string filePath = "D:\\workspace\\c_sharp\\files\\lb5\\file_students.txt";
        private static string[] subdevisions = { "Maths", "Programming", "Humanities", "Science" };
        ...
        {
            Console.WriteLine("Enter name of {0} you wnt to look through\n", subdivision);
